	     ...
	     Int_t nEvents = 1)
{
  ...
  FairDetector* fgd = new geometry::FgdDetector("Granular Detector","/home/georgi/opt/Essnusb/ESSnuSB-soft/EsbGeometry/EsbSuperFGD/EsbConfig/geometry",0,0,2000, kTRUE);
  fRun->AddModule(fgd);
