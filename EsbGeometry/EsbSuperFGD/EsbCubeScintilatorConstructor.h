...
public:
     ...
     **/
    CubeScintConstructor(std::string name);

    /** Destructor **/
    virtual ~CubeScintConstructor();

    /** Get the constructed TGeoVolume **/
  ...
  /** Set the Fiber Hole position along X axis
     ...
     **/
  virtual void SetHolePosition_X(const ThreeVector& pos) {fHolePositionX = pos;};

  /** Get the Fiber Hole position along X axis **/
  virtual const ThreeVector& GetHolePosition_X(void) {return fHolePositionX;};

  /** Set the Fiber Hole position along Y axis
     *@param pos - position along Y axis
     **/
  virtual void SetHolePosition_Y(const ThreeVector& pos) {fHolePositionY = pos;};

  /** Get the Fiber Hole position along Y axis **/
  virtual const ThreeVector& GetHolePosition_Y(void) {return fHolePositionY;};

  /** Set the Fiber Hole position along Z axis
     *@param pos - position along Z axis
     **/
  virtual void SetHolePosition_Z(const ThreeVector& pos) {fHolePositionZ = pos;};

  /** Get the Fiber Hole position along Z axis **/
  virtual const ThreeVector& GetHolePosition_Z(void) {return fHolePositionZ;};
  ...
  /** Set rotation for the Fiber Hole along X axis
     ...
     **/
  virtual void SetHoleRot_X(const RotMatrix& rot) {fHoleRotX = rot;};
  /** Get rotation for the Fiber Hole along X axis **/
  virtual RotMatrix GetHoleRot_X(void) {return fHoleRotX;};

  /** Set rotation for the Fiber Hole along Y axis
     *@param rot - rotation along Y axis
     **/
  virtual void SetHoleRot_Y(const RotMatrix& rot) {fHoleRotY = rot;};
  /** Get rotation for the Fiber Hole along Y axis **/
  virtual RotMatrix GetHoleRot_Y(void) {return fHoleRotY;};

  /** Set rotation for the Fiber Hole along Z axis
     *@param rot - rotation along Z axis
     **/
  virtual void SetHoleRot_Z(const RotMatrix& rot) {fHoleRotZ = rot;};
  /** Get rotation for the Fiber Hole along Z axis **/
  virtual RotMatrix GetHoleRot_Z(void) {return fHoleRotZ;};
  ...
  virtual void SetGap(double g) {fGap = g;};
    ...
    /** Get current name **/ 
    virtual std::string GetName(void) {return fname;}
