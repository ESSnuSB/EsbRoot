...
ClassImp(EsbPassiveContFact)

static EsbPassiveContFact gEsbPassiveContFact;

EsbPassiveContFact::EsbPassiveContFact()
  : FairContFact()
{
  // Constructor (called when the library is loaded)
  fName="EsbPassiveContFact";
  fTitle="Factory for parameter containers in libPassive";
  setAllContainers();
  FairRuntimeDb::instance()->addContFactory(this);
}

void EsbPassiveContFact::setAllContainers()
{
...
FairParSet* EsbPassiveContFact::createContainer(FairContainer* c)
{
