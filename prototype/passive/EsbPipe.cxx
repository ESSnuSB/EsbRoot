...
EsbPipe::EsbPipe(const char * name, const char * title)
...
// -----  ConstructGeometry  --------------------------------------------------
void EsbPipe::ConstructGeometry()
{
    ...
    // ---> Volume
    TGeoVolume* pipe = new TGeoVolume("EsbPipe", shape, Carbon);
    ...
    // ---> Volume
    TGeoVolume* Vpipe = new TGeoVolume("EsbPipe", shape, Vacuum);
