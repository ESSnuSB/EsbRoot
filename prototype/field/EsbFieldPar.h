...
// -------------------------------------------------------------------------
// -----                    EsbFieldPar header file                  -----
// -----                Created 26/03/14  by M. Al-Turany              -----
// -------------------------------------------------------------------------



#ifndef EsbFieldPar_H
#define EsbFieldPar_H 1
...
class EsbFieldPar : public FairParGenericSet
{
 ...
 public:
  ...
  EsbFieldPar(const char* name, const char* title, const char* context);
...
/** default constructor  **/
 ...
 private:
  ...
  EsbFieldPar(const EsbFieldPar&);
  EsbFieldPar& operator=(const EsbFieldPar&);

  ClassDef(EsbFieldPar,1);
