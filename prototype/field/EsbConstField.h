...
#ifndef EsbConstField_H
#define EsbConstField_H 1
...
class EsbConstField : public FairField
{
 ...
 public:    
   ...
   **/
  EsbConstField(const char* name, Double_t xMin, Double_t xMax,
		Double_t yMin, Double_t yMax, Double_t zMin,
		Double_t zMax, Double_t bX, Double_t bY, Double_t bZ);


  /** Constructor from EsbFieldPar **/
  EsbConstField(EsbFieldPar* fieldPar);


  /** Destructor **/
  virtual ~EsbConstField();
