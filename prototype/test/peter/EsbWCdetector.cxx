...
void EsbWCdetector::ConstructGeometry()
{
  ...
  // (sea) water
  const Int_t nEnergies = 32;
  const Double_t photEnergies[nEnergies] = {
  ...
  const Double_t refractIdxSeaWater[nEnergies] = {
  ...
  const Double_t absSeaWater[nEnergies] = {
