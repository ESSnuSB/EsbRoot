#include "EsbGenerators/SimpleGenieOnlyMuonGenerator.h"
...
SimpleGenieOnlyMuonGenerator::SimpleGenieOnlyMuonGenerator(int pdg_tgt, int pdg_nu, double e_nu,
		TVector3 const& dir_nu, TLorentzVector const& x4_nu) : GenieOnlyMuonGenerator(), fVertexX4(x4_nu)
{
...
/*virtual*/ void SimpleGenieOnlyMuonGenerator::PostProcessEvent(/*IN OUT*/ genie::GHepRecord* event)
{
