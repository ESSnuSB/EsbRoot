#ifndef ESBROOT_GENERATOR_GENIE_ONLY_MUON_GENERATOR_H
#define ESBROOT_GENERATOR_GENIE_ONLY_MUON_GENERATOR_H 1

//! @file EsbGenerators/GenieOnlyMuonGenerator.h
...
//! @copyright ESSnuSB consortium. Released under GPLv3 (<https://www.gnu.org/licenses/gpl-3.0.en.html>).
class GenieOnlyMuonGenerator : public FairGenerator
{
...
public:
	...
	static struct GlobalState_t {
		...
		std::string fOutputMuonFileName = ""; //!< Path to XML file with GENIE cross sections
	...
	//! Empty constructor
	GenieOnlyMuonGenerator() {};
	
	//! Basic constructor
	GenieOnlyMuonGenerator(genie::GFluxI *fluxI, genie::GeomAnalyzerI *geomI);

	//! Empty destructor
  	virtual ~GenieOnlyMuonGenerator();
...
private:
	...
	//! written to a root file!
  	...
  	ClassDef(GenieOnlyMuonGenerator,6)
};
